...
public class Appreal extends Merchandise {
    private final ArrayList<String> sizes = new ArrayList<>();
    private final ArrayList<String> colors = new ArrayList<>();

    public Appreal(String name, String desc, double price, int quantity, String category, String theme, String[] sizeArray, String[] colorArray) {
    ...
    public String describe(){
        ...
        return getName()+newline+
                ...
                "AvailableColors: " + String.join(", ",colors) + newline +
                getTheme()+pipe+getPrice()+newline;
    }
}
